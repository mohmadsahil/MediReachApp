...
const AllDoctors = () => {
  ...
  return (
    <>
      <div className="w-full min-h-screen bg-white">
        ...
        <div className="flex px-4 mt-4">
          <button
            ...
            className={`flex-1 text-sm text-[12px] font-semibold py-2 px-2 rounded-l-lg flex flex-col items-center ${
              activeTab === "clinic"
          ...
          <button
            ...
            className={`flex-1 text-sm text-[12px] font-semibold py-2 px-2 rounded-r-lg flex flex-col items-center ${
              activeTab === "video"
                ? "bg-blue-800 text-white"
                : "bg-gray-100 text-gray-700"
            }`}
        ...
        <div className="px-2 mt-4 space-y-6 mb-25">
          {doctorData.map((doc, idx) => (
            <div
              key={idx}
              onClick={() =>
                navigate("/doctors-info", { state: { doctor: doc } })
              }
      ...
      {/* <LocationSelector isOpen={isOpen} setIsOpen ={setIsOpen}/> */}
    </>
  );
};
